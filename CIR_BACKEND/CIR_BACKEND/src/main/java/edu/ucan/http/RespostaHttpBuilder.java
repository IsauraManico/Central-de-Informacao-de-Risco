...
public class RespostaHttpBuilder
{
    ...
    public static ResponseEntity<RespostaHttp> sucesso(String mensagem, Object informacao)
    {
    ...
    public static ResponseEntity<RespostaHttp> erro(String mensagem, Object informacao)
    {
        RespostaHttp response = new RespostaHttp();
    ...
    public static ResponseEntity<RespostaHttp> naoEncontrado(String mensagem, Object informacao)
    {
        RespostaHttp response = new RespostaHttp();
    ...
    public static ResponseEntity<RespostaHttp> naoPermitido(String mensagem, Object informacao)
    {
        RespostaHttp response = new RespostaHttp();
    ...
    public static ResponseEntity<Object> requisicaoMalFormada(String mensagem, Object informacao)
    {
        RespostaHttp response = new RespostaHttp();
