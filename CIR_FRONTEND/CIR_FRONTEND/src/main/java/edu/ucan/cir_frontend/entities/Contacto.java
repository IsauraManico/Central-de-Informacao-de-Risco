...
@NamedQueries({
    ...
    @NamedQuery(name = "Contacto.findByPkContacto", query = "SELECT c FROM Contacto c WHERE c.pkContacto = :pkContacto"),
    @NamedQuery(name = "Contacto.findByDescricao", query = "SELECT c FROM Contacto c WHERE c.descricao = :descricao")})
public class Contacto implements Serializable {
    ...
    public String toString() {
        return "edu.ucan.cir_frontend.entities.Contacto[ pkContacto=" + pkContacto + " ]";
    }
